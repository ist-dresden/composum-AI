...
(function ($, channel, window, undefined) {
  ...
  channel.on("cq-layer-activated", function (event) {
    if (event.layer === "Edit") {
      Granite.author.EditorFrame.editableToolbar.registerAction("Composum-AI", chatgptAction);
      console.log("Composum AI action registered");
    }
  });
