...
## Composum AI Approximate Markdown Service Configuration (ApproximateMarkdownServiceImpl)
...
## Composum AI OpenAI Configuration (GPTChatCompletionServiceConfig)
...
| requestsPerMinute | Maximum requests per minute | int |  | Maximum count of requests to ChatGPT per minute - from the second half there will be a slowdown to avoid hitting the limit. Default 100 |
| requestsPerHour | Maximum requests per hour | int |  | Maximum count of requests to ChatGPT per hour - from the second half there will be a slowdown to avoid hitting the limit. Default 1000 |
| requestsPerDay | Maximum requests per day | int |  | Maximum count of requests to ChatGPT per day - from the second half there will be a slowdown to avoid hitting the limit. Default 3000 |
...
## Composum AI Prompt Library Configuration (GPTPromptLibrary)
...
### Composum AI Translation Service Configuration (GPTTranslationServiceImpl)
...
## Composum AI SlingCaConfig Plugin (basename)
