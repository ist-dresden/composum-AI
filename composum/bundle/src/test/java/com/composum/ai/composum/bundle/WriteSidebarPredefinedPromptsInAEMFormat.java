 ...
 */
public class WriteSidebarPredefinedPromptsInAEMFormat {

    public static void main(String[] args) {
        final String jsonfile = "/sidebar/predefinedprompts.json";
        jsonListToXML(WriteSidebarPredefinedPromptsInAEMFormat.class, jsonfile, false);
    }
